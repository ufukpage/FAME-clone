...
def main_worker(gpu, ngpus_per_node, args):
    ...
    data_dir = os.path.join(args.data, 'video')
    anno_dir = os.path.join(args.data, 'split')
    ...
    if args.evaluate:
        ...
        return
    if args.multiprocessing_distributed and args.gpu == 0:
        log_dir = "{}_bs={}_lr={}_cs={}_wd={}".format(args.log_dir, args.batch_size, args.lr, args.crop_size,
                                                      args.weight_decay)
